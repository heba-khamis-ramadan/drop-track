...
authController.put("/update-user", error_1.default.asyncHandler(auth_middleware_1.default.authentication), error_1.default.asyncHandler(user_service_1.default.update_user));
